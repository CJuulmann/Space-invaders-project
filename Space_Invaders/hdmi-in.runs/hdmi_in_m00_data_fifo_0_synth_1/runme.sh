...
HD_PWD='C:/dev/Git/project_v1/week3/Space_Invaders/hdmi-in.runs/hdmi_in_m00_data_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_in_m00_data_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_in_m00_data_fifo_0.tcl
